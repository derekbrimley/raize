...
var submitQuiz = function(){
	...
	if(!interest_1_value && !interest_2_value && !interest_3_value && !interest_4_value && !interest_5_value){
		alert("You must select at least one interest.");
		$("#majorsContainer").hide();
		$("#interestsContainer").show();
	}else if(!adjective_1_value && !adjective_2_value && !adjective_3_value && !adjective_4_value && !adjective_5_value){
		alert("You must select at least one adjective.");
		$("#majorsContainer").hide();
		$("#adjectivesContainer").show();
